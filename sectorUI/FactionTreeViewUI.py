...
class FactionTreeViewUI:
    ...
    def __init__(self, faction_controller, parent, x_coord, y_coord):
        ...
        self.faction_treeview = ttk.Treeview(self.faction_frame, columns=['Name', 'HP', 'Force', 'Cunning', 'Wealth', 'FacCreds', 'Homeworld', 'XP'])
        ...
        self.add_faction_button = tk.Button(self.faction_frame, text='Add Faction', command=self.open_new_faction_window)
